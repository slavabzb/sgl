...
public:
    virtual void setUp() override
    {
        ...
        this->view->add_edge(sgl::edge(0, 1, 7));
        this->view->add_edge(sgl::edge(0, 3, 5));
        this->view->add_edge(sgl::edge(1, 3, 9));
        this->view->add_edge(sgl::edge(1, 2, 8));
        this->view->add_edge(sgl::edge(1, 4, 7));
        this->view->add_edge(sgl::edge(2, 4, 5));
        this->view->add_edge(sgl::edge(3, 4, 15));
        this->view->add_edge(sgl::edge(3, 5, 6));
        this->view->add_edge(sgl::edge(4, 5, 8));
        this->view->add_edge(sgl::edge(4, 6, 9));
        this->view->add_edge(sgl::edge(5, 6, 11));
        
        this->minimal_spanning_tree = std::make_shared<sgl::view::adjacency_list>(oriented, weighted);
        this->minimal_spanning_tree = this->view;
        this->minimal_spanning_tree->remove_edge(sgl::edge(1, 3, 9));
        this->minimal_spanning_tree->remove_edge(sgl::edge(1, 2, 8));
        this->minimal_spanning_tree->remove_edge(sgl::edge(3, 4, 15));
        this->minimal_spanning_tree->remove_edge(sgl::edge(4, 5, 8));
        this->minimal_spanning_tree->remove_edge(sgl::edge(5, 6, 11));
    }
